...
Pay and close the order
    ...
    Wait For Element and Text    ${PAYMENT_INFO}    Payment Information:    ${SHIPPING_INFO}    Shipping Information:    ${PRICE_TOTAL}    Price Total
    Wait For Element and Text    ${PAYMENT_CARD}    SauceCard #31337    ${SHIPPING_METHOD}    Free Pony Express Delivery!
